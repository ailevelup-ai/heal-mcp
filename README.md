...
[![Platform](https://img.shields.io/badge/platform-macOS%20%7C%20Linux%20%7C%20Windows-lightgrey)](https://github.com/yourusername/heal-mcp)
...
```bash
cd ~/.claude/skills
git clone https://github.com/yourusername/heal-mcp.git
```
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/heal-mcp/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/heal-mcp/discussions)
